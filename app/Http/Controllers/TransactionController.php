...
class TransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'trans_type_id' => "required|numeric|max:999",
            'party_type_id' => "required|numeric|max:999",
            'party_id' => "required|numeric|max:99999999",
            'trans_purpose_id' => "required|numeric|max:99999999",
            'trans_method_id' => "required|numeric|max:999",
            'bank_id' => "nullable|numeric|max:99999999",
            'check_number' => "nullable|string|max:100",
            'transfer_method_id' => "nullable|numeric|max:99999999",
            'amount' => "required|numeric|max:99999999.99|regex:/^\d+(\.\d{1,2})?$/ ",
            'date' => "required|date",
            'note' => "nullable|string|max:200",
            'file_image' => "nullable|mimes:png,jpeg,jpg,gif,pdf|max:5120",
        ]);
        if ($validator->fails()) {
            $response = [
                "status" => "error",
    ...
    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'bank_id' => "nullable|numeric|max:99999999",
            'check_number' => "nullable|string|max:100",
            'transfer_method_id' => "nullable|numeric|max:999",
            'amount' => "required|numeric|max:99999999.99|regex:/^\d+(\.\d{1,2})?$/",
            'date' => "required|date",
            'note' => "nullable|string|max:200",
            'file_image' => "nullable|mimes:png,jpeg,jpg,gif,pdf|max:5120",
